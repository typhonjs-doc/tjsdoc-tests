...
if (testConfig.category.html && testConfig.html.category.manual)
{
         ...
         describe('test navigation', () =>
         {
            ...
            it('has manual navigation', () =>
            {
               ...
               Util.find(doc, '[data-ice="nav"]', (doc) =>
               {
                  ...
                  Util.assert.includes(doc, '[data-ice="manual"]:nth-of-type(5)', 'Usage Usage2 h2 in usage2 h3 in usage2');
                  ...
                  Util.find(doc, '[data-ice="manual"]:nth-of-type(9)', (doc) =>
                  {
                     ...
                     Util.assert.includes(doc, '[data-ice="manualNav"]:nth-of-type(2) a', 'identifiers.html#class', 'href');
                  ...
                  {
                     Util.assert.includes(doc, '[data-ice="manualNav"]:nth-of-type(1) a', 'manual/changelog/CHANGELOG.html',
                      'href');
