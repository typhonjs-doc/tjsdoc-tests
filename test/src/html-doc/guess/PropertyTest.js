      ...
      describe('TestGuessProperty', () =>
      {
         ...
         describe('in summary', () =>
         {
            it('has guessed member.', () =>
            {
               ...
               Util.findParent(doc, '[data-ice="summary"] [href$="#instance-member-p2"]', '[data-ice="target"]',
                (doc) =>
               {
                  Util.assert.includes(doc, null, 'public p2: number[]');
               });

               Util.findParent(doc, '[data-ice="summary"] [href$="#instance-member-p3"]', '[data-ice="target"]',
                (doc) =>
               {
                  Util.assert.includes(doc, null, 'public p3: {"x1": number, "x2": string}');
               });

               Util.findParent(doc, '[data-ice="summary"] [href$="#instance-member-p4"]', '[data-ice="target"]',
                (doc) =>
               {
