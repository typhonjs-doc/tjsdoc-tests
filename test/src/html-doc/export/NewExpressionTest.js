      ...
      describe('test default export with new expression.', () =>
      {
         describe('default export', () =>
         {
            it('has instance description', () =>
            {
               ...
               {
                  Util.assert.includes(doc, null, 'You can directly use an instance of this class. testExportNewExpression');
               ...
               //try
               //{
               //   Util.assert.includes(doc, '.header-notice [data-ice="importPath"]', 'import');
               //}
               //catch (err)
               //{
               //   return;
         ...
         describe('named export', () =>
         {
            it('has instance description', () =>
            {
               ...
               Util.find(doc, '[data-ice="instanceDocs"]', (doc) =>
               {
                  Util.assert.includes(doc, null, 'You can directly use an instance of this class. testExportNewExpression2');
